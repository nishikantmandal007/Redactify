...
provide_help_info() {
    ...
    echo "   Check requirements: curl -fsSL https://raw.githubusercontent.com/nishikantmandal007/Redactify/main/scripts/check-requirements.sh | bash"
    echo "   Reinstall:         curl -fsSL https://raw.githubusercontent.com/nishikantmandal007/Redactify/main/scripts/quick-install.sh | bash"
    echo "   Uninstall:         curl -fsSL https://raw.githubusercontent.com/nishikantmandal007/Redactify/main/scripts/uninstall.sh | bash"
    echo ""
